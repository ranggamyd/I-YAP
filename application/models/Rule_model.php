...
class Rule_model extends CI_Model
{
    ...
    public function getDataByPenyakitGejala($id_penyakit, $id_gejala)
    {
        ...
        return $query->row(); // Mengembalikan satu baris hasil query atau null jika tidak ditemukan
    }
    ...
    // public function edit($data, $id_rule, $cek, $cek2)
    // {
    //     if ($cek->num_rows() >= 1 && $cek2->num_rows() >= 1) {
