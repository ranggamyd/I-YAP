...
class Diagnosa_model extends CI_Model
{
    ...
    {
        // $this->db->join('penyakit', 'penyakit.id_penyakit = diagnosa.id_penyakit', 'left');
        // $this->db->join('gejala', 'gejala.id_gejala = diagnosa.id_gejala', 'left');
        return $this->db->get('hasil')->result_array();
    }

    public function getGejala()
    {
        // Ambil data gejala dari database, misalnya menggunakan query
    ...
    {
        // Ambil data kondisi dari database, misalnya menggunakan query
    ...
    {
        // Ambil teks kondisi dari database, misalnya menggunakan query
        $query = $this->db->get('kondisi');
        $kondisiText = array();
    ...
    {
        // Ambil data penyakit dari database, misalnya menggunakan query
